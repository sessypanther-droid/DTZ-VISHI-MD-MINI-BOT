...
const connectdb = async () => {
    if (!config.MONGODB_URI) {
        console.warn('⚠️ MONGODB_URI is not configured. Set it in Railway Variables.');
        return;
    }
...
const userConfigSchema = new mongoose.Schema({
    ...
    config: {
        ...
        AUTO_STATUS_MSG: { type: String, default: 'Hello from DTZ VISHI MD!' },
    ...
    try {
        ...
        if (config) {
            ...
            const defaultConfig = {
                ...
                AUTO_STATUS_MSG: 'Hello from DTZ VISHI MD!',
                AUTO_LIKE_EMOJI: ['❤️', '👍', '😮', '😎'],
